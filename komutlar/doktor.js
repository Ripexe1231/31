...
exports.run = (client, message, args) => {
    message.delete()
    if (!message.member.roles.find("name", "ᕒ Discord Yetkilisi ᓬ")) {
        return message.channel.send(' **Bu Komutu Kullanmak için** \*`ᕒ Discord Yetkilisi ᓬ*\` **Rolüne Sahip Olman Lazım** ')
